...
def boot():
    if sys.platform.startswith("win"): os.system("title WOCK IP // BLACKLIST CHECKER")
...
if __name__ == "__main__":
    try:
        ...
        console.print(Align.center(Panel(
            Text.from_markup("[bold red]WOCK-MULTI[/]  [dim]//[/]  [white]WOCK IP[/]  [dim]//[/]  [red]BLACKLIST CHECKER[/]"),
