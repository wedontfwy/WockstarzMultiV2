...
def boot():
    if sys.platform.startswith("win"):
        os.system("title WOCK // NUMBER INFO")
...
if __name__ == "__main__":
    try:
        ...
        console.print(Align.center(Panel(
            Text.from_markup("[bold red]WOCK-MULTI[/]  [dim]//[/]  [white]NUMBER INFO[/]  [dim]//[/]  [red]OSINT[/]"),
        ...
        os.system("cls" if os.name == "nt" else "clear")
        console.print(Align.center(Panel(
            Text.from_markup("[bold red]WOCK-MULTI[/]  [dim]//[/]  [white]NUMBER INFO[/]  [dim]//[/]  [red]REPORT[/]"),
            border_style="red", padding=(0, 6)
        )))
